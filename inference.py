...
class InferenceHandler:
    ...
    def inference(self, audio, audio_sr, audio_path, outpath=None, valid_programs=None, num_beams=1):
        audio = librosa.to_mono(librosa.resample(audio, orig_sr=audio_sr, target_sr=self.SAMPLE_RATE))
